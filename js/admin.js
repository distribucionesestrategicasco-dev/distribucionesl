...
function generarPDFCotizacion(orderId) {
  ...
  var html = '<!DOCTYPE html><html><head><meta charset="UTF-8">'
    ...
    + '.header{background:linear-gradient(135deg,#0A0806 0%,#1A1208 100%);padding:28px 36px;display:flex;justify-content:space-between;align-items:center}'
    + '.logo{height:56px}'
    + '.gold-line{height:3px;background:linear-gradient(90deg,transparent,#E2C47A 25%,#C8A558 75%,transparent)}'
    + '.meta{background:#FAF7F0;padding:20px 36px;display:grid;grid-template-columns:1fr 1fr;gap:12px 40px;border-bottom:1px solid #EDE5C8}'
    + '.meta-item label{font-size:10px;font-weight:700;text-transform:uppercase;color:#9A7535;letter-spacing:1.2px}'
    + '.meta-item span{font-size:14px;font-weight:600;display:block;margin-top:2px;color:#1A1208}'
    ...
    + 'th{padding:10px 12px;font-size:10px;color:#E2C47A;text-align:left;font-weight:700;letter-spacing:1px}'
    ...
    + '.totals-box{background:#FAF7F0;border:1px solid #EDE5C8;border-left:3px solid #C8A558;border-radius:8px;padding:14px 20px;min-width:240px}'
    + '.totals-row{display:flex;justify-content:space-between;font-size:14px;color:#9A7535;padding:4px 0}'
    + '.totals-total{display:flex;justify-content:space-between;font-size:16px;font-weight:800;color:#1A1208;border-top:1px solid #C8A558;padding-top:8px;margin-top:6px}'
    + '.footer{background:#0A0806;color:rgba(226,196,122,0.50);padding:14px 36px;font-size:10px;display:flex;justify-content:space-between;margin-top:32px}'
