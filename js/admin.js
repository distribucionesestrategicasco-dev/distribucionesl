...
function _buildRemisionHTML(datos) {
  ...
  return '<div id="remision-print" style="font-family:\\'Outfit\\',Arial,sans-serif;background:#fff;font-size:13px;display:flex;flex-direction:column;min-height:297mm">'
    ...
    + (notas ? '<div style="padding:0 24px 10px"><div style="background:#F8F9FA;border-radius:8px;padding:10px 14px;border-left:3px solid #0872E6">'
        ...
        + '<div style="padding:10px 24px 14px;border-top:1px solid #E8E8EA;display:grid;grid-template-columns:1fr 1fr;gap:30px;margin-top:auto" class="firmas-block">'      + '<div style="text-align:center"><div style="font-size:9px;font-weight:700;color:#6E6E73;text-transform:uppercase;letter-spacing:1px;margin-bottom:4px">Firma Despachador</div>'
